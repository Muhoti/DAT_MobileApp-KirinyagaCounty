...
import ke.co.osl.kirinyagacountyfarmermappingapp.models.AddValueChainBody
...
//            }
//
//            if (TextUtils.isEmpty(harvestProduction.text.toString())) {
//                error.text = "Harvest Production cannot be empty!"
//                return@setOnClickListener
//            }
//
//            if (TextUtils.isEmpty(yearlyProduction.text.toString())) {
//                error.text = "Yearly Production cannot be empty!"
//                return@setOnClickListener
//            }
