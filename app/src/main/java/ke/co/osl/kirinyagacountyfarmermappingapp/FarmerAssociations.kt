package ke.co.osl.kirinyagacountyfarmermappingapp
...
import ke.co.osl.kirinyagacountyfarmermappingapp.api.ApiInterface
import ke.co.osl.kirinyagacountyfarmermappingapp.models.FarmerAssociationsBody
import ke.co.osl.kirinyagacountyfarmermappingapp.models.FarmersDetailsGetBody
import ke.co.osl.kirinyagacountyfarmermappingapp.models.Message
            ...
            apiInterface.enqueue( object : Callback<Message> {
                override fun onResponse(call: Call<Message>?, response: Response<Message>?) {
                    ...
                    if(response?.body()?.success !== null){
                        gdialog.hide()
                        displayFarmerGroups(groupsBody.FarmerID)
                    }
            ...
            apiInterface.enqueue( object : Callback<List<FarmersDetailsGetBody>> {
                override fun onResponse(call: Call<List<FarmersDetailsGetBody>>, response: Response<List<FarmersDetailsGetBody>>?) =
                    if (response?.body()?.size!! > 0){
                        ...
                        progress.visibility = View.GONE
                        System.out.println("The searched Farmer ID is " + response?.body()?.get(0)?.NationalID + response?.body())
                        dialog.hide()
