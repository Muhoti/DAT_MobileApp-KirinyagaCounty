...
import ke.co.osl.kirinyagacountyfarmermappingapp.models.FarmersLocationBody
...
//        try {
    ...
    private fun postFarmerDetails() {
        ...
        next.setOnClickListener {
            ...
            if (acc >= 25) {
                error.text = "Too low accuracy...please wait while system detects better accuracy!"
                return@setOnClickListener
            }

            if(lat == 0.0 && lng == 0.0){
                error.text = "Wrong location detected. Turn on your location!!"
                return@setOnClickListener
            }
